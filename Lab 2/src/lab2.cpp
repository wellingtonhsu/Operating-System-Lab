...
int main(int arg, char* argv[]){
	...
	//Print Summary
	cout <<scheduler_type<<" "<<quantum<<endl;
	for (int i=0; i<processes.size(); i++)
	{
	...
	printf("SUM: %d %.2lf %.2lf %.2lf %.2lf %.3lf\n",
	       current_time,
	       cpu_util/current_time*100,
	       io_util/current_time*100,
